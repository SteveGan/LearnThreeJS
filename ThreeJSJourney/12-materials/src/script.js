...
const guiNormalScale = gui.addFolder("material.normalScale");
guiNormalScale.add(material.normalScale, 'x').min(0).max(10).step(0.001);
guiNormalScale.add(material.normalScale, 'y').min(0).max(10).step(0.001);
